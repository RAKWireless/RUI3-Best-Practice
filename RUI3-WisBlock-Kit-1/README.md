...
# Example For the WisBlock Kit 1 setup using RUI3
...
- [Pilotak LPS35HW library](https://github.com/pilotak/LPS35HW), can be installed from Arduino Library Manager
- [Closed Cube](https://github.com/closedcube/ClosedCube_OPT3001_Arduino), can be installed from Arduino Library Manager     
